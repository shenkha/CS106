python pacman.py -n 5 -l capsuleClassic -p MinimaxAgent -a depth=2,evalFn=betterEvaluationFunction -f --frameTime 0 -q
python pacman.py -n 5 -l capsuleClassic -p AlphaBetaAgent -a depth=2,evalFn=betterEvaluationFunction -f --frameTime 0 -q
python pacman.py -n 5 -l capsuleClassic -p ExpectimaxAgent -a depth=2,evalFn=betterEvaluationFunction -f --frameTime 0 -q
python pacman.py -n 5 -l contestClassic -p MinimaxAgent -a depth=2,evalFn=betterEvaluationFunction -f --frameTime 0 -q
python pacman.py -n 5 -l contestClassic -p AlphaBetaAgent -a depth=2,evalFn=betterEvaluationFunction -f --frameTime 0 -q
python pacman.py -n 5 -l contestClassic -p ExpectimaxAgent -a depth=2,evalFn=betterEvaluationFunction -f --frameTime 0 -q
python pacman.py -n 5 -l mediumClassic -p MinimaxAgent -a depth=2,evalFn=betterEvaluationFunction -f --frameTime 0 -q
python pacman.py -n 5 -l mediumClassic -p AlphaBetaAgent -a depth=2,evalFn=betterEvaluationFunction -f --frameTime 0 -q
python pacman.py -n 5 -l mediumClassic -p ExpectimaxAgent -a depth=2,evalFn=betterEvaluationFunction -f --frameTime 0 -q
...
python pacman.py -n 5 -l contestClassic -p MinimaxAgent -a depth=2,evalFn=scoreEvaluationFunction -f --frameTime 0 -q
python pacman.py -n 5 -l contestClassic -p AlphaBetaAgent -a depth=2,evalFn=scoreEvaluationFunction -f --frameTime 0 -q
python pacman.py -n 5 -l contestClassic -p ExpectimaxAgent -a depth=2,evalFn=scoreEvaluationFunction -f --frameTime 0 -q
python pacman.py -n 5 -l mediumClassic -p MinimaxAgent -a depth=2,evalFn=scoreEvaluationFunction -f --frameTime 0 -q
python pacman.py -n 5 -l mediumClassic -p AlphaBetaAgent -a depth=2,evalFn=scoreEvaluationFunction -f --frameTime 0 -q
python pacman.py -n 5 -l mediumClassic -p ExpectimaxAgent -a depth=2,evalFn=scoreEvaluationFunction -f --frameTime 0 -q
...
python pacman.py -n 5 -l contestClassic -p MinimaxAgent -a depth=2,evalFn=betterEvaluationFunction -f --frameTime 0 -q -g DirectionalGhost
python pacman.py -n 5 -l contestClassic -p AlphaBetaAgent -a depth=2,evalFn=betterEvaluationFunction -f --frameTime 0 -q -g DirectionalGhost
python pacman.py -n 5 -l contestClassic -p ExpectimaxAgent -a depth=2,evalFn=betterEvaluationFunction -f --frameTime 0 -q -g DirectionalGhost
python pacman.py -n 5 -l mediumClassic -p MinimaxAgent -a depth=2,evalFn=betterEvaluationFunction -f --frameTime 0 -q -g DirectionalGhost
python pacman.py -n 5 -l mediumClassic -p AlphaBetaAgent -a depth=2,evalFn=betterEvaluationFunction -f --frameTime 0 -q -g DirectionalGhost
python pacman.py -n 5 -l mediumClassic -p ExpectimaxAgent -a depth=2,evalFn=betterEvaluationFunction -f --frameTime 0 -q -g DirectionalGhost
...
python pacman.py -n 5 -l contestClassic -p MinimaxAgent -a depth=2,evalFn=scoreEvaluationFunction -f --frameTime 0 -q -g DirectionalGhost
python pacman.py -n 5 -l contestClassic -p AlphaBetaAgent -a depth=2,evalFn=scoreEvaluationFunction -f --frameTime 0 -q -g DirectionalGhost
python pacman.py -n 5 -l contestClassic -p ExpectimaxAgent -a depth=2,evalFn=scoreEvaluationFunction -f --frameTime 0 -q -g DirectionalGhost
python pacman.py -n 5 -l mediumClassic -p MinimaxAgent -a depth=2,evalFn=scoreEvaluationFunction -f --frameTime 0 -q -g DirectionalGhost
python pacman.py -n 5 -l mediumClassic -p AlphaBetaAgent -a depth=2,evalFn=scoreEvaluationFunction -f --frameTime 0 -q -g DirectionalGhost
python pacman.py -n 5 -l mediumClassic -p ExpectimaxAgent -a depth=2,evalFn=scoreEvaluationFunction -f --frameTime 0 -q -g DirectionalGhost
